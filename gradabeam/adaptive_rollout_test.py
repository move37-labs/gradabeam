...
test_adabeam_equivalence_substring_count
    Gate: AdaptiveRolloutDesigner(UniformActionStrategy(allow_silent_edits=True),
...
def _make_legacy_designer(oracle_name: str, fixture: dict) -> AdaptiveRolloutDesigner:
    ...
    designer = AdaptiveRolloutDesigner(
        ...
        strategy=UniformActionStrategy(allow_silent_edits=True),
        use_gradients=False,
...
def test_equivalence_gate_is_not_vacuous():
    ...
    (generate_random_mutant_actionspace, non-ref sampling) consumes the RNG
